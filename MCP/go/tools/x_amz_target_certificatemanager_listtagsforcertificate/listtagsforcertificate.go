...
func ListtagsforcertificateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ListTagsForCertificateRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=CertificateManager.ListTagsForCertificate", cfg.BaseURL)
		...
		var result models.ListTagsForCertificateResponse
...
func CreateListtagsforcertificateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=CertificateManager_ListTagsForCertificate",
		mcp.WithDescription("Lists the tags that have been applied to the ACM certificate. Use the certificate's Amazon Resource Name (ARN) to specify the certificate. To add a tag to an ACM certificate, use the <a>AddTagsToCertificate</a> action. To delete a tag, use the <a>RemoveTagsFromCertificate</a> action. "),
		...
		mcp.WithString("CertificateArn", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ListtagsforcertificateHandler(cfg),
	}
}
