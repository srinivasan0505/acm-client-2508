...
func PutaccountconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutAccountConfigurationRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=CertificateManager.PutAccountConfiguration", cfg.BaseURL)
...
func CreatePutaccountconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=CertificateManager_PutAccountConfiguration",
		...
		mcp.WithObject("ExpiryEvents", mcp.Description("")),
		mcp.WithString("IdempotencyToken", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    PutaccountconfigurationHandler(cfg),
	}
}
