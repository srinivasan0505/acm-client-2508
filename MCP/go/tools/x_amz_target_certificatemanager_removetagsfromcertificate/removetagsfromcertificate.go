...
func RemovetagsfromcertificateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.RemoveTagsFromCertificateRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=CertificateManager.RemoveTagsFromCertificate", cfg.BaseURL)
...
func CreateRemovetagsfromcertificateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=CertificateManager_RemoveTagsFromCertificate",
		mcp.WithDescription("<p>Remove one or more tags from an ACM certificate. A tag consists of a key-value pair. If you do not specify the value portion of the tag when calling this function, the tag will be removed regardless of value. If you specify a value, the tag is removed only if it is associated with the specified value. </p> <p>To add tags to a certificate, use the <a>AddTagsToCertificate</a> action. To view all of the tags that have been applied to a specific ACM certificate, use the <a>ListTagsForCertificate</a> action. </p>"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    RemovetagsfromcertificateHandler(cfg),
	}
}
