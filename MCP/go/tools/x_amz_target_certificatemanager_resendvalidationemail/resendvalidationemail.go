...
func ResendvalidationemailHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ResendValidationEmailRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=CertificateManager.ResendValidationEmail", cfg.BaseURL)
...
func CreateResendvalidationemailTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=CertificateManager_ResendValidationEmail",
		...
		mcp.WithString("ValidationDomain", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ResendvalidationemailHandler(cfg),
	}
}
