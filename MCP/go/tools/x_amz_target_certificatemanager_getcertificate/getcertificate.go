...
func GetcertificateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetCertificateRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=CertificateManager.GetCertificate", cfg.BaseURL)
		...
		var result models.GetCertificateResponse
...
func CreateGetcertificateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=CertificateManager_GetCertificate",
		mcp.WithDescription("Retrieves an Amazon-issued certificate and its certificate chain. The chain consists of the certificate of the issuing CA and the intermediate certificates of any other subordinate CAs. All of the certificates are base64 encoded. You can use <a href="https://wiki.openssl.org/index.php/Command_Line_Utilities">OpenSSL</a> to decode the certificates and inspect individual fields."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetcertificateHandler(cfg),
	}
}
