...
func DescribecertificateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.DescribeCertificateRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=CertificateManager.DescribeCertificate", cfg.BaseURL)
		...
		var result models.DescribeCertificateResponse
...
func CreateDescribecertificateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=CertificateManager_DescribeCertificate",
		mcp.WithDescription("<p>Returns detailed metadata about the specified ACM certificate.</p> <p>If you have just created a certificate using the <code>RequestCertificate</code> action, there is a delay of several seconds before you can retrieve information about it.</p>"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribecertificateHandler(cfg),
	}
}
