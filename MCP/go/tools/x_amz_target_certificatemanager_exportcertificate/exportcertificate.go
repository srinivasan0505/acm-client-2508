...
func ExportcertificateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.ExportCertificateRequest
		...
		url := fmt.Sprintf("%s/#X-Amz-Target=CertificateManager.ExportCertificate", cfg.BaseURL)
		...
		var result models.ExportCertificateResponse
...
func CreateExportcertificateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_#X-Amz-Target=CertificateManager_ExportCertificate",
		...
		mcp.WithString("Passphrase", mcp.Required(), mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ExportcertificateHandler(cfg),
	}
}
