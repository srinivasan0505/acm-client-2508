/**
 * MCP Server function for <p>Deletes a certificate and its associated private key. If this action succeeds, the certificate no longer appears in the list that can be displayed by calling the <a>ListCertificates</a> action or be retrieved by calling the <a>GetCertificate</a> action. The certificate will not be available for use by Amazon Web Services services integrated with ACM. </p> <note> <p>You cannot delete an ACM certificate that is being used by another Amazon Web Services service. To delete a certificate that is in use, the certificate association must first be removed.</p> </note>
 */
...
class Post_X_Amz_Target_Certificate_Manager_Delete_CertificateMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_X_Amz_Target_Certificate_Manager_Delete_CertificateHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("CertificateArn")) {
            queryParams.add("CertificateArn=" + args.get("CertificateArn"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_x_amz_target_certificate_manager_delete_certificate" + queryString;
    ...
    public static MCPServer.Tool createPost_X_Amz_Target_Certificate_Manager_Delete_CertificateTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_x_amz_target_certificate_manager_delete_certificate",
        ...
        return new MCPServer.Tool(definition, getPost_X_Amz_Target_Certificate_Manager_Delete_CertificateHandler(config));
    }
