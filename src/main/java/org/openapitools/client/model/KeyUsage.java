...
import org.openapitools.client.model.KeyUsageName;
...
public class KeyUsage {
  ...
  public KeyUsage name(@javax.annotation.Nullable KeyUsageName name) {
    this.name = name;
    return this;
  }
  ...
  public void setName(@javax.annotation.Nullable KeyUsageName name) {
    this.name = name;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, keyUsage.name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Name") != null && !jsonObj.get("Name").isJsonNull()) {
        KeyUsageName.validateJsonElement(jsonObj.get("Name"));
      }
  }
